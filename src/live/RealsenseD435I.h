...
#ifndef DMVIO_RealsenseD435I_H
#define DMVIO_RealsenseD435I_H
...
namespace dmvio
{
// Class for interacting with the RealsenseD435I camera.
...
public:
    ...
    RealsenseD435I(FrameContainer& frameContainer, std::string cameraCalibSavePath, DatasetSaver* datasetSaver);
